...
#### ⚠️ CRITICAL: Error Handling and Human Safety
...
2. **ALWAYS log errors before throwing** – create an audit trail
3. **NEVER silently swallow errors** – every error must be visible
