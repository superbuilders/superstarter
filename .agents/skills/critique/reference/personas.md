...
If `.github/copilot-instructions.md` contains a `## Design Context` section (generated by `teach-alpha-style`), derive 1–2 additional personas from the audience and brand information:
