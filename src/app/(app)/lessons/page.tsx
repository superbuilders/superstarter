...
// interactivity. The Lessons surface is a follow-up PRD per Dashboard
// PRD §16 + §19; this page exists so the to-be-built TopNav's
// "Lessons" link doesn't 404.
		...
		<main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center gap-6 px-6 py-12">
			<header className="space-y-2">
				...
				<p className="text-sm text-text-2">
					Lessons are coming soon. We'll add them once the practice surface is dialed
					in.
				</p>
			</header>
			<Link
