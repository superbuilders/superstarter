...
function buildSystemPrompt(): string {
	...
	lines.push(
		...
		'- numerical.workrate — "If 8 parts take 20 minutes to make, how many minutes does it take to make 6 parts?" (combined-work, rate-of-completion, or single-actor/uniform-rate work) → {"subTypeId":"numerical.workrate","difficulty":"medium","confidence":0.96}',
