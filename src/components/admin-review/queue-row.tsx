// <QueueRow> — one candidate row in the admin /admin/review queue.
//
...
//   6. Chevron
//
// Click navigates to /admin/review/${item.id}. The item-detail page lands
// at §2.2 commit-0; until then the link 404s, which is expected behavior
